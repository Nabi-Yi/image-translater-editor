...
export function Button5() {
  return (
    <div className="flex flex-col gap-2 w-[360px] mx-auto mt-10">
      <Button variant="outline" className="w-full h-10 flex justify-center items-center gap-2" onClick={() => {}}>
        ...
        <span className="text-sm font-medium leading-5">Sign in with Google</span>
      </Button>
      ...
      <Button variant="outline" className="w-full h-10 flex justify-center items-center gap-2" onClick={() => {}}>
        ...
        <span className="text-sm font-medium leading-5">Sign in with Facebook</span>
      </Button>
      ...
      <Button variant="outline" className="w-full h-10 flex justify-center items-center gap-2" onClick={() => {}}>
        ...
        <span className="text-sm font-medium leading-5">Sign in with GitHub</span>
      </Button>
    </div>
  );
}
