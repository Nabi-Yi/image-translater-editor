        ...
        <div className="flex flex-col gap-y-12 justify-between h-full">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-lg text-white mb-6">
              "Shadcn UI Kit for Figma has completely transformed our design process. It's incredibly intuitive and
              saves us so much time. The components are beautifully crafted and customizable."
            </p>
          </div>
          <div>
            <p className="font-semibold text-white">Sarah Thompson</p>
            <p className="text-white">Lead UX Designer at BrightWave Solutions</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-background px-2 text-muted-foreground uppercase">or sign in with</span>
              </div>
            </div>
                ...
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <clipPath id="clip0_772_108">
                      <rect width="16" height="16" fill="currentColor" transform="translate(0.166504 0.5)" />
                    </clipPath>
                  </defs>
                </svg>
              </Button>
                ...
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <clipPath id="clip0_772_70">
                      <rect width="16" height="16" fill="white" transform="translate(0.833008 0.5)" />
                    </clipPath>
                  </defs>
                </svg>
              </Button>
